window.PorfolioConfig = {
  ...
  jobDescription: "I'm a Python Developer with experience in SQL, HTML, and JavaScript. I specialize in developing robust applications and have contributed to many projects, enhancing their functionality and user experience",
  skills: [
    {
      name: 'Python',
      description: ''
  ...
  contacts: {
    email: 'abrahambryan2003@gmail.com',
    mobileNo: '+91 9895772707',
    // phoneNo: '+12 345 6789',
    links: [
      {
        name: 'LinkedIn',
        link: 'https://www.linkedin.com/in/bryan-abraham-800002255/'
      },
      // {
      //   name: 'Facebook',
